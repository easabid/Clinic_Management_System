...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-blue-50 via-white to-blue-50 py-24 px-8 text-center">
        <div className="max-w-3xl mx-auto">
          <span className="inline-block bg-blue-100 text-blue-700 text-sm font-medium
          ...
          <p className="text-xl text-gray-500 mb-10 max-w-2xl mx-auto">
            Book doctor appointments, manage health records — all in one platform.
          </p>
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Link
              href="/register"
              className="px-8 py-3.5 bg-blue-600 text-white font-semibold
                rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200"
            >
              Book an Appointment
            </Link>
            <Link
      ...
      <section className="py-20 px-8 bg-blue-600 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <Link
            href="/register"
            className="inline-block px-8 py-3.5 bg-white text-blue-700 font-semibold
      ...
      <footer className="py-8 px-8 border-t border-gray-100 text-center">
        <p className="text-gray-400 text-sm">
          © 2025 Clinic Management System. All rights reserved to  E.A.SABID
        </p>
      </footer>
    </div>
  );
